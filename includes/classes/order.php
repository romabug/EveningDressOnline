...
class order extends base {
  ...
  function query($order_id) {
    ...
    $order_query = "select customers_id, customers_name, customers_company,
                         ...
                         delivery_city, delivery_postcode,delivery_phone, delivery_state, delivery_country,
                         delivery_address_format_id, billing_name, billing_company,
                         billing_street_address, billing_suburb, billing_city, billing_postcode,billing_phone,
    ...
    $this->delivery = array('name' => $order->fields['delivery_name'],
                            ...
                            'phone' => $order->fields['delivery_phone'],
    ...
    $this->billing = array('name' => $order->fields['billing_name'],
                           ...
                           'phone' => $order->fields['billing_phone'],
                           'state' => $order->fields['billing_state'],
                           'country' => $order->fields['billing_country'],
                           'format_id' => $order->fields['billing_address_format_id']);

    $index = 0;
    $orders_products_query = "select `orders_products_id`, op.`products_id`, `products_name`, `products_image`
                                 `products_model`, op.`products_price`, `products_tax`,
                                 op.`products_quantity`, `final_price`,`onetime_charges`,
