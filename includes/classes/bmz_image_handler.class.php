 ...
 * @version $Id: bmz_image_handler.class.php,v 1.8 2006/05/01 12:19:30 tim Exp $
 */
	...
	function initialize_overlays($sizetype) {
		...
		switch ($sizetype) {
			case 'large':
				...
				$this->zoom['file'] = ($ihConf['large']['zoom']) ? $ihConf['dir']['docroot'] . $ihConf['dir']['images'] . 'large/zoom' . $ihConf['large']['suffix'] . '.png' : '';
				break;
			case 'medium':
				...
				$this->zoom['file'] = ($ihConf['medium']['zoom']) ? $ihConf['dir']['docroot'] . $ihConf['dir']['images'] . 'medium/zoom' . $ihConf['medium']['suffix'] . '.png' : '';
				break;
			case 'small':
				$this->watermark['file'] = ($ihConf['small']['watermark']) ? $ihConf['dir']['docroot'] . $ihConf['dir']['images'] . 'watermark.png' : '';
				$this->zoom['file'] = ($ihConf['small']['zoom']) ? $ihConf['dir']['docroot'] . $ihConf['dir']['images'] . 'zoom.png' : '';
				break;
			default:
				$this->watermark['file'] = '';
				$this->zoom['file'] = '';
