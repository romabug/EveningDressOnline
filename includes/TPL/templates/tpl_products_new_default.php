...
?>
<div class="pagebar border_b gray_bg"><span class="fl"><?php echo $products_new_split->display_count(TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW); ?></span><ul class="fr"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_drop_down(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?></ul></div>
<?php
  }
?>
<div class="list_bar">
    <ul>
      ...
      <?php switch($listTypes){
        ...
        <a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'listtypes=2').cleanSameArgNoHtml('listtypes');?>"><span class="list_grid">Grid</span></a>    
        <a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'listtypes=3').cleanSameArgNoHtml('listtypes');?>"><span class="list_gallery">Gallery</span></a>    
      <?php break;
                case '2':?>
        <a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'listtypes=1').cleanSameArgNoHtml('listtypes');?>"><span class="list_list">List</span></a>
      ...
      <span class="category">
      <a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'display=2').cleanSameArgNoHtml('display');?>">   Wholesale Only
      </a>    </span>       
      <span class="category">
      <a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'display=3').cleanSameArgNoHtml('display');?>">    Free Shipping
      </a>    </span>
      <?php break;
      case '2':?>
      <span class="category"><a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'display=1').cleanSameArgNoHtml('display');?>">ALL</a></span>
      ...
      case '3':?>
      <span class="category"><a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'display=1').cleanSameArgNoHtml('display');?>">ALL</a></span>
      <span class="category"><a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW, 'display=2').cleanSameArgNoHtml('display');?>">Wholesale Only</a></span>       
...
?>
<div class="pagebar margin_t g_t_c gray_bg"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></div>
<?php
  }
?>
<?php
