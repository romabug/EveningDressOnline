 ...
 */
require(DIR_WS_MODULES . zen_get_module_directory('featured_category_row.php'));

  require($template->get_template_dir('tpl_featured_row_display.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/tpl_featured_row_display.php');
?>