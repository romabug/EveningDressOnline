...
?>
          <ul class="list_product clear">
            <li class="relative"><?php echo $display_products_image; ?>
              
            </li>
            <li class="li_con">
              <dl>
                <dt><?php echo $display_products_name; ?></dt>
                <dd><?php echo $display_products_description;?></dd>
                <dd><?php echo $display_products_model; ?></dd>
              </dl>
            </li>
            <li>
              <dl>
                <dt><?php echo $display_products_price; ?></dt>
                <dd><?php echo $display_products_button; ?></dd>
              </dl>
            </li>
          </ul>
<?php
