...
//
?>
<?php echo zen_draw_form('faq_reviews_write', zen_href_link(FILENAME_FAQ_REVIEWS_WRITE, 'action=process&faqs_id=' . $_GET['faqs_id']), 'post', 'onsubmit="return checkForm(faq_reviews_write);"'); ?>
<table  width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td class="pageHeading" valign="top" colspan="2"><h1><?php echo $faqs_name; ?></h1></td>
  </tr>
<?php
...
?>
  ...
  <tr>
    <td class="main"><?php echo '<a href="' . zen_href_link(FILENAME_FAQ_REVIEWS, zen_get_all_get_params(array('reviews_id', 'action'))) . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?></td>
