...
<div class="pad_10px fr"><?php echo DOWN_FOR_MAINTENANCE_STATUS_TEXT; ?></div>
<br class="clear" />
<div class="pad_10px fr"><a href="<?php echo zen_href_link(FILENAME_DEFAULT); ?>"><?php echo zen_image_button(BUTTON_IMAGE_CONTINUE, BUTTON_CONTINUE_ALT); ?></a></div>
<br class="clear" />
<!-- body_text_eof //-->
</div>
