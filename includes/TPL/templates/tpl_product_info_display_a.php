...
<!-- EOF Product Tools-->    </div> 
  ...
  <div style=" width:700px; margin-left:22px; margin-right:15px; "></div>    
...
<div style="display: none;" id="size_tab02">
	  <div id="Item_Description_Spc" class="pad_10px pad_l_28px big">
	     ...
	     <p  class="margin_t blue"><a href="/images/promotions/colorchart.jpg" target="_blank" ><img src="/images/banner/colorchart.jpg" width="250" height="134" border="0" /></a></p>
		 <br/>
...
<a name="review"></a>
	...
	<p>Have any question or inquire for our wedding dresses? Please contact <a target="_blank" class="red u" href="/faq.html">Customer Service</a>. </p>
	<ul class="inquiry">	
