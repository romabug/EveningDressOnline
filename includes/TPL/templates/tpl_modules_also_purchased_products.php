...
<div class="allborder pad_1em margin_t pad_bottom" id="alsoPurchased">
<?php
  require($template->get_template_dir('tpl_also_purchased_products.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/tpl_also_purchased_products.php');
?>
</div>
<?php } ?>
