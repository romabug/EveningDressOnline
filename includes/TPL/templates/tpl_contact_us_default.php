...
<?php if ($current_page == 'contact_us') {?>
<div class="clear border_b_d">&nbsp;</div>
<div id="popup_ask_a_question" class="pad_10px">
<?php echo zen_draw_form('ask_a_question', zen_href_link(FILENAME_CONTACT_US, 'action=send&products_id=' . $_GET['products_id']),'post','onsubmit="return(fmChk(this))"'); ?>
<?php
