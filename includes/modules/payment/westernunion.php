...
function update_status() {
   ...
   function selection() {
     return array('id' => $this->code,
                   ...
                   'info'=>'<ul><li><b>Beneficiary:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_FIRST_NAME.MODULE_PAYMENT_WESTERNUNION_RECEIVER_LAST_NAME.'</li>'.
                           '<li><b>First Name:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_FIRST_NAME.'</li>'.
                           '<li><b>Last Name:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_LAST_NAME.'</li>'.
                           '<li><b>Country:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_COUNTRY.'</li>'.
                           '<li><b>Address:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_ADDRESS.'</li>'.
                           '<li class="margin_t"><b class="red">NOTICE:</b>'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_NOTICE.'</li></ul>'
                            );
   }
