    ...
    if ($this->enableDirectPayment == false) {
      return array('id' => $this->code,
                   ...
                   'info'=>'<li>If you <b>have paypal account</b>, you can pay your order by your paypal account.</li>
					                  ...
					                  <li>wedding-dresses-sydney.com.au\'s paypal account is : <b>'.MODULE_PAYMENT_PAYPALWPP_APIUSERNAME.'</b></li>
                            ...
                            <img border="0" src="includes/templates/lightinthebox/images/logo/PaypalVerify.gif"/>
                            </a>'
                            );
    }
