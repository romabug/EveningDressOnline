...
//                        $selected_attribute = ($products_options->fields['attributes_default']=='1' ? true : false);
                    ...
                    switch ($products_options_names->fields['products_options_images_style']) {
                      ...
                      if ($tmp_attributes_image_row > $products_options_names->fields['products_options_images_per_row']) {
                        $tmp_attributes_image .= '<br class="clear" />' . "\n";
                  ...
                  if (($products_options_names->fields['products_options_type'] == PRODUCTS_OPTIONS_TYPE_TEXT)) {
                    ...
                    if ($_POST['id']) {
                      ...
                      if(strstr($products_options_names->fields['products_options_name'],'(Inch)')===false){
					  $tmp_html .= $products_options_details;
					  }
                      $tmp_word_cnt_string = '';
                ...
                switch (true) {
				  ...
				  if(strstr($products_options_names->fields['products_options_name'],'(Inch)')!==false){
				  	$options_size_text_name[] = '<label class="attribsInput" for="' . 'attrib-' . $products_options_names->fields['products_options_id'] . '-' . $products_options_value_id . '">' . $products_options_names->fields['products_options_name'] . '</label>';
					$options_size_text_menu[] = $tmp_html . "\n";
					$options_size_text_comment[] = $products_options_names->fields['products_options_comment'];
					$options_size_text_comment_position[] = ($products_options_names->fields['products_options_comment_position'] == '1' ? '1' : '0');
					break;
				  }
				  ...
				  if(strstr($products_options_names->fields['products_options_name'],'(Inch)')!==false){
				  	$options_size_text_readonly_name[] = '<label class="attribsInput" for="' . 'attrib-' . $products_options_names->fields['products_options_id'] . '-' . $products_options_value_id . '">' . $products_options_names->fields['products_options_name'] . '</label>';
					$options_size_text_readonly_menu[] = $tmp_html . "\n";
					$options_size_text_readonly_comment[] = $products_options_names->fields['products_options_comment'];
					$options_size_text_readonly_comment_position[] = ($products_options_names->fields['products_options_comment_position'] == '1' ? '1' : '0');
					break;
				  }
                  $options_name[] = $products_options_names->fields['products_options_name'];
                  $options_menu[] = $tmp_html . "\n";
...
// 下句修改具体选项宽度, 修改为 190px ， 原来150px

                  $options_menu[] = zen_draw_pull_down_menu('id[' . $products_options_names->fields['products_options_id'] . ']', $products_options_array, $selected_attribute, 'id="' . 'attrib-' . $products_options_names->fields['products_options_id'] . '" style="border: 1px solid #ddd; width: 190px;"') . "\n";
                  $options_comment[] = $products_options_names->fields['products_options_comment'];
                  $options_comment_position[] = ($products_options_names->fields['products_options_comment_position'] == '1' ? '1' : '0');
                  break;
                }
