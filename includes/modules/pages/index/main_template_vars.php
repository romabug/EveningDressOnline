...
if ($category_depth == 'nested')
{
  ...
  if (isset($cPath) && strpos($cPath, '_'))
  {
    ...
    for($i=0; $i<$n; $i++)
    {
      ...
      if ($categories->fields['total'] < 1)
      {
        ...
        $categories_query = "SELECT c.categories_id, cd.categories_name, c.categories_image, c.parent_id,c.categories_display_type
                             FROM   " . TABLE_CATEGORIES . " c, " . TABLE_CATEGORIES_DESCRIPTION . " cd
                             WHERE      c.parent_id = :parentID
                             AND        c.categories_id = cd.categories_id
                             AND        cd.language_id = :languagesID
  ...
  */
  ...
  $categories_displayTypes = zen_get_categories_displayTypes($current_category_id);
	$categories_listTypes = zen_get_categories_listTypes($current_category_id);
  ////////////////////// ///////////////////////////////////////////////////////////////////////////////
...
$current_bottom_categories_description = "";
// categories_description
$sql = "SELECT categories_description,categories_bottom_description
...
if ($categories_description_lookup->RecordCount() > 0) {
  ...
  $current_bottom_categories_description = $categories_description_lookup->fields['categories_bottom_description'];
}
