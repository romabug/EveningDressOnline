...
// set flag for attributes module usage:
    $flag_show_weight_attrib_for_this_prod_type = SHOW_DOCUMENT_PRODUCT_INFO_WEIGHT_ATTRIBUTES;
// get attributes
...
// build show flags from product type layout settings
  ...
  $zco_notifier->notify('NOTIFY_MAIN_TEMPLATE_VARS_END_DOCUMENT_PRODUCT_INFO');
?>
