 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $tpl_page_body = '/tpl_print_page_display.php';
    ...
    $sql = "select p.products_id, pd.products_name,
	 ...
	 mat.products_id, mat.metatags_title, mat.metatags_keywords, mat.metatags_description,
           ...
           from   " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd,  " . TABLE_META_TAGS_PRODUCTS_DESCRIPTION . " mat
           where  p.products_status = '1'
           and    p.products_id = '" . (int)$_GET['products_id'] . "'
           and    pd.products_id = p.products_id
	 
		   and    mat.products_id = p.products_id
	...
	$ppp1 = $product_info->fields['metatags_title']; 
	 $ppp2 = $product_info->fields['metatags_keywords'];
	  $ppp3 = $product_info->fields['metatags_keywords'];
