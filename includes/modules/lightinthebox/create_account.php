 ...
 */
  ...
  $zone_id = 0;
  $error = false;
  $email_format = (ACCOUNT_EMAIL_PREFERENCE == '0' ? 'HTML' : 'TEXT');
...
if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
  ...
  if ($error == true) {
    ...
    $sql_data_array = array('customers_lastname' => 'New Customer',
