...
//These Constant addBy shOwQ

	define('TEXT_BOX_POPULAR_SEARCHES','Popular Searches');

	define('SEO_COMMON_KEYWORDS','wedding dresses sydney >');

	

	//	define('SEO_COMMON_KEYWORDS','Wholesale');  页面导航 的文字 如 首页 > xxx

	

//products_listing.php 

	define('PRODUCTS_LISTING_WRITE_VIEWS','Write a review');

//split_page_results.php

	define('PRODUCTS_LISTING_PAGE_TEXT','Page');
...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', '   19b Saywell St Chatswood NSW 2067  &nbsp;&nbsp; Phone: (02)&nbsp;8006 1977 &nbsp;&nbsp; Mobile: 0412 545 228 &nbsp;&nbsp; <br/> Copyright &copy; 2008-2012 Cklaa Art All Rights Reserved. &nbsp;&nbsp;

    <div style="visibility:hidden" >

 <script language="javascript" type="text/javascript" src="http://js.users.51.la/9971117.js"></script>
...
// on Windows try 'en', or 'English'
  ...
  define('DATE_FORMAT', 'F j, Y'); // this is used for date()
...
// categories_css box text in sideboxes/categories_css.php

  define('BOX_HEADING_CATEGORIES', 'See All Categories');

	

// categories box text in sideboxes/categories.php

  define('BOX_HEADING_CATEGORIES_BOX', 'Narrow By');

	define('BOX_SUBHEADING_CATEGORIES_BOX','Category');
...
// order_history box text in sideboxes/order_history.php
  ...
  define('BOX_HEADING_CUSTOMER_ORDERS', 'Recent Orders');
...
// information box text in sideboxes/information.php
  ...
  define('BOX_INFORMATION_SHIPPING', 'About Dropship');
...
// javascript messages
  ...
  define('ENTRY_COMPANY', 'Wedding Date:');
  ...
  define('ENTRY_PHONE_NUMBER', 'Phone Number: ');

  define('ENTRY_PHONE_NUMBER_TEXT', '*');
  ...
  define('ENTRY_STATE', 'State/Province/Region:');
  ...
  define('ESTIMATOR_SHIPPING_TO','shipping to: ');

  define('SHIPPING_ESTIMATOR_ENTRY_COUNTRY','Ship to:');
  ...
  define('ENTRY_NEWSLETTER', 'Yes, please send me e-mails about special offers, exclusives and promotions.');
  ...
  define('ENTRY_PASSWORD', 'Create a password:');
  ...
  define('ENTRY_PASSWORD_CURRENT', 'Re - enter password:');

  define('ENTRY_PASSWORD_CURRENT_TEXT', '*');

  define('ENTRY_PASSWORD_CURRENT_ERROR', 'Your Password must contain a minimum of ' . ENTRY_PASSWORD_MIN_LENGTH . ' characters.');

  define('ENTRY_WHICH_BEST_YOU', 'Customer Type');

  define('ENTRY_HOW_DID_YOU_KNOW', 'How did you know Our '. STORE_NAME .'?');
  ...
  define('FORM_REQUIRED_INFORMATION', '<span class="red">*</span>Indicates required fields');

  define('FORM_SKIP_TO_ADDRESS_TEXT', ' ');
  ...
  define('TEXT_DISPLAY_NUMBER_OF_BEST_DEAL', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> Best Deals)');

  define('TEXT_DISPLAY_NUMBER_OF_FREE_SHIPPING', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> Free Shipping)');

  define('TEXT_DISPLAY_NUMBER_OF_SEARCH_RESULT', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> Search Result)');
...
// textarea attribute input fields
  ...
  define('TEXT_MAXIMUM_CHARACTERS_ALLOWED','characters allowed');
...
// Shipping Estimator
  ...
  define('CART_SHIPPING_METHOD_RATES', 'Shipping Cost');

  define('CART_SHIPPING_METHOD_TOTAL_COST', 'Total Cost');
