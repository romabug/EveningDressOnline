...
/*  define('TEXT_SELECTED_BILLING_DESTINATION', 'The billing address should match the address on your credit card statement. You can change the billing address by clicking the <em>Change Address</em> button.');   */

define('TEXT_SELECTED_BILLING_DESTINATION', '<strong>Use a coupon and pay less.</strong> <br> * you can share FREE CUSTOM SIZING coupon with friends.');
