...
//  
  ...
  define('BOX_HEADING_SUBSCRIBE', 'Newsletter<br/><span class="b_">for Wholesale</span>'); // sidebox title
  
  define('BUTTON_IMAGE_SUBSCRIBE', 'button_subscribe.gif');
  define('BUTTON_SUBSCRIBE_ALT', 'Subscribe');
  define('BOX_SUBSCRIBE_DEFAULT_TEXT', 'about the latest offers and deals Subscribe today!');
...
// header Subscribe Button/Box Subscribe Button
  ...
  define('HEADER_SUBSCRIBE_DEFAULT_TEXT', 'Your email address'); // in input field
