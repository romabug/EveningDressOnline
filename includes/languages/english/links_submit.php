...
define('EMAIL_TEXT_APPROVED', 'Your link has been successfully submitted at ' . STORE_NAME . ' and is now live on our links pages.' . "\n\n");
...
define('SEND_EXTRA_SYBMIT_LINKS_TO_SUBJECT', '[LINK SUBMIT]');
...
define('EMAIL_DISCLAIMER_NEW_CUSTOMER', 'This link was submitted to us by you or by one of our users. If you did not submit a link, or feel that you have received this email in error, please send an email to %s ');
