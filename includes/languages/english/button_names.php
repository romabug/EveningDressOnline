...
define('BUTTON_IMAGE_CONTINUE', 'button_continue_checkout.gif');
...
define('BUTTON_IMAGE_PLACE_CHECKOUT', 'button_place_order.gif');
...
define('IMAGE_BUTTON_SUBMIT', 'Submit Request');
...
define('BUTTON_PLACE_ALT', 'Place Order');
