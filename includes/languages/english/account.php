...
define('HEADING_TITLE', 'Welcome to your '.STORE_NAME.' account.  <span class="big b_">  Manage your information, orders, preferences.</span>');

define('OVERVIEW_TITLE', 'Overview');
define('OVERVIEW_SHOW_ALL_ORDERS', '(show all orders)');
define('OVERVIEW_PREVIOUS_ORDERS', 'Your Order Status');//Previous Orders
