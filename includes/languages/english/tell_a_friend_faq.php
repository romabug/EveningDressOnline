...
define('EMAIL_TEXT_SUBJECT', 'Your friend %s has recommended this FAQ from %s');
...
define('EMAIL_TEXT_LINK', 'To view the FAQ, click on the link below or copy and paste the link into your web browser:' . "\n\n" . '%s');
