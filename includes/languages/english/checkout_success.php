...
define('TEXT_SEE_ORDERS', 'An Email of order confirmation has been sent, to see order history  click &nbsp;&nbsp;<a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">My Account</a>  .');
define('TEXT_CONTACT_STORE_OWNER', '* Submit a question to <a href="' . zen_href_link(FILENAME_CONTACT_US) . '">customer service</a>.');
