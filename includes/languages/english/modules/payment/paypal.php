 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_IMG', 'includes/templates/lightinthebox/images/checkout/pic_2.jpg');
  
    define('MODULE_PAYMENT_VISA1_MARK_BUTTON_IMG', 'includes/templates/lightinthebox/images/checkout/logo_ccVisa.gif');
	    define('MODULE_PAYMENT_VISA2_MARK_BUTTON_IMG', 'includes/templates/lightinthebox/images/checkout/logo_ccMC.gif');
		    define('MODULE_PAYMENT_VISA3_MARK_BUTTON_IMG', 'includes/templates/lightinthebox/images/checkout/logo_ccBank.gif');
	
	
	
  
  define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_ALT', 'Checkout with PayPal');
  define('MODULE_PAYMENT_PAYPAL_ACCEPTANCE_MARK_TEXT', 'Pay by Paypal, if you already have a Paypal account. <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
(also can Pay by Credit/Debit Card &nbsp;<img src="' . MODULE_PAYMENT_VISA1_MARK_BUTTON_IMG . '" /> <img src="' . MODULE_PAYMENT_VISA2_MARK_BUTTON_IMG . '" /> <img src="' . MODULE_PAYMENT_VISA3_MARK_BUTTON_IMG . '" /> &nbsp; protected and verified by Paypal.) ');
  ...
  define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_TXT', 'The safer, easier way to pay.');
