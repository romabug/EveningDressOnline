...
//
  ...
  define('MODULE_PAYMENT_WESTERNUNION_RECEIVER_NOTICE', ' PLEASE EMAIL YOUR ORDER NUMBER ,THE WESTERN UNION CONTROL NUMBER,AMOUNT,SENDER\'S FIRST AND LAST NAME,SENDER\'S ADDRESS AND COUNTRY,SENDER\'S PHONE NUMBER TO '.'admin@admin.com'.' AFTER YOUR SEND PAYMENT BY WESTERN UNION. THANKS!');
  ...
  define('MODULE_PAYMENT_WESTERNUNION_MARK_BUTTON_IMG', 'includes/templates/lightinthebox/images/checkout/pic_3.jpg');
  define('MODULE_PAYMENT_WESTERNUNION_MARK_BUTTON_ALT', 'Checkout with Western Union');
  define('MODULE_PAYMENT_WESTERNUNION_ACCEPTANCE_MARK_TEXT', '(Pay By WESTERN UNION Will Have<strong>7% Discount</strong> ');
