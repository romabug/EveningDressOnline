...
define('TEXT_PRODUCT_FEATURED_REVIEW','FEATURED REVIEW');
define('TEXT_WRITE_REVIEW_SUCCESS','Thank you for your comments, we will within the next 24 hours.');
...
define('TEXT_PRODUCT_OPTIONS', ' To add to shopping cart, please select ');
