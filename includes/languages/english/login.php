...
define('HEADING_TITLE', '<span class="red">Login</span> or Create a account');

define('HEADING_NEW_CUSTOMER', 'New Customers');
define('HEADING_NEW_CUSTOMER_SPLIT', 'New Customers');

define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'If you don\'t have an account with.<strong>' . STORE_NAME .'</strong>, please create one.');
...
define('TEXT_PASSWORD_FORGOTTEN', 'password?');
